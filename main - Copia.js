                ...
                dano(dano, inimigo){
                    ...
                    function myLoop() {         //  create a loop function
                        setTimeout(function() {   //  call a 3s setTimeout when the loop is called
                          player.x +=  -   (Math.sign(((player.sprU * colisionDir(this)) + (player.sprU * colisionEsq(this))))* 3)
                          player.dirD = 0
                          player.jump = 1
                          player.dirE = 0       //  your code here
                          ...
                          if (i < 30) { 
                            ...
                            if(player.right == 1 || player.left == -1){
                                player.dirD = dirD
                                player.dirE = dirE
